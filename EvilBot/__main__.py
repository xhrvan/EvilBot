...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/5f630844151b800517a14.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *bts bot @armiy_v*
...
buttons = [
    [
     ...
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/armiy_v"),
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *bts bot* [👿](https://telegra.ph/file/5f630844151b800517a14.jpg)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @armiy_v \
