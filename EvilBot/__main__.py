...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/af75e8fd4b8d21d6f1a7e.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *hyper Sriki OP*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/hyper_Sriki_bot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="MY Boss💝", @Srikanth_36),
        InlineKeyboardButton(
            text="join", url=f"@we_all_are_best_friends"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url= "@We_all_are_best_friends"),
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *hyper Sriki OP* [👿](https://telegra.ph/file/af75e8fd4b8d21d6f1a7e.jpg)
