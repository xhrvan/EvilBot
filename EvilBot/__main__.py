...
buttons = [
    [
     ...
     [
        ...
        InlineKeyboardButton(
            text="𝕛𝕠𝕚𝕟", url="https://t.me/we_all_are_best_friends"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/legend_bot_support"),
        InlineKeyboardButton(text="𝙲𝚑𝚊𝚗𝚗𝚎𝚕", url="https://t.me/legend_bot_updates"),
    ], 
...
HELP_STRINGS = "
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *🄻🄴🄶🄴🄽🄳 🄱🄾🅃* [👿](https://telegra.ph/file/01efe2bcd59ba04b2bac0.jpg)
